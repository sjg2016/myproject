...
public class Constants {
    ...
    public final static String STORE_PATH = System.getProperty("store.path", "c:/tmp");
    ...
    public final static int PRO_MAX = Integer.valueOf(System.getProperty("pro.max", ""+4*1000*1000));
