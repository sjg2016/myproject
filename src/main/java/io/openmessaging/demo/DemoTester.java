...
public class DemoTester {
    ...
    public static void main(String[] args) {
         ...
         */
        properties.put("STORE_PATH", "c:/home/admin/test");
        ...
        List<Message> messagesForQueue2 = new ArrayList<>(1024*1024);
        ...
        long T1 = end - start;
        System.out.println(String.format("Write cost:%d ms tps:%d q/ms", T1, 1024*1024*4/(T1)));
